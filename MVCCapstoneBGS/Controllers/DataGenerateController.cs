    ...
    public class DataGenerateController : Controller
    {
        ...
        public ActionResult GenerateYearReport(int year)
        {
            ...
            using (var excelPackage = new ExcelPackage(memoryStream))
            {
                ...
                int Person = ws.Dimension.End.Row+5;

                ws.Cells[Person, 1].Value = "Generated by: "+ Session["Username"];
                ws.Cells[Person + 1, 1].Value = "Date and Time Generated: " + DateTime.Now.ToString();
